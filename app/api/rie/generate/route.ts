    ...
    const report = await prisma.rieReport.create({
      data: {
        ...
        intakeData: {
          ...
          heeftArbodienst: werkplekData.heeftArbodienst === "ja",
          referralOpportunity: werkplekData.heeftArbodienst !== "ja",
          partnerCode: werkplekData.partnerCode || null,
          utm: {
            source: werkplekData.utmSource || null,
            medium: werkplekData.utmMedium || null,
            campaign: werkplekData.utmCampaign || null,
          },
        },
        status: "PENDING",
      },
